$(document).ready(() => {
    ...
    let econ_arr = ["共産主義", "社会主義", "平等寄り", "中立", "競争寄り", "社会ダーウィニズム", "黒暗森林"]
    let govt_arr = ["無政府主義", "自由意志主義", "自由寄り", "中立", "管理主義寄り", "家長制", "全能主義"]
    let scty_arr = ["革新派", "進歩派", "進歩寄り", "中立", "保守寄り", "保守派", "反動派"]
    let envo_arr = ["原始主義", "科学技術懐疑主義", "伝統寄り", "中立", "科学技術優先", "科学技術主義", "科学技術至上主義"]
    let ntal_arr = ["永世帝国", "帝国主義", "国家統一主義寄り", "中立", "自治寄り", "民族主義", "民族発明"]
    let cmty_arr = ["個人の原子化", "個人主義", "個人主義寄り", "中立", "社群主義寄り", "社群主義", "社会凝结核"]
    let idea_arr = ["超理想主義", "理想主義", "理想主義寄り", "中立", "現実主義", "権謀主義", "レーニン主義"]
    let dipl_arr = ["売国的", "ハト派", "やや妥協的", "中立", "やや強硬", "タカ派", "戦狼戦士"]
